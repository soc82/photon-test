...
<strong>full_name</strong> - Full name',
		...
		array(
			'key' => 'field_5b9bafb45e4bf',
			'label' => 'Attendee Parental Consent email subject',
			'name' => 'attendee_parental_consent_email_subject',
			'type' => 'text',
			'instructions' => 'Used when an event attendee is adding an extra attendee under 18 that is NOT their child.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5b9b3fd267dcb',
			'label' => 'Attendee Parental Consent email content',
			'name' => 'attendee_parental_consent_email_content',
			'type' => 'wysiwyg',
			'instructions' => 'Used when an event attendee is adding an extra attendee under 18 that is NOT their child.',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5b9b9fed67ccc',
			'label' => 'Attendee Parental Consent email link text',
			'name' => 'attendee_parental_consent_email_link_text',
			'type' => 'text',
			'instructions' => 'Used when an event attendee is adding an extra attendee under 18 that is NOT their child.',
			'required' => 0,
			'conditional_logic' => 0,
