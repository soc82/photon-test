...
<strong>full_name</strong> - Full name',
		...
		array(
			...
			'label' => 'New attendee email subject - Adult',
			'name' => 'new_attendee_email_subject_adult',
			'type' => 'text',
		...
		array(
			...
			'label' => 'New attendee email content - Adult',
			'name' => 'new_attendee_email_content_adult',
			'type' => 'wysiwyg',
			'instructions' => 'Used when an event attendee is new to the system.',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5b1b3bb90e2cc',
			'label' => 'New attendee email subject - Child',
			'name' => 'new_attendee_email_subject_child',
			'type' => 'text',
			'instructions' => 'Used when an event attendee is new to the system.',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5b2b4fb554dbb',
			'label' => 'New attendee email content - Child',
			'name' => 'new_attendee_email_content_child',
			'type' => 'wysiwyg',
			'instructions' => 'Used when an event attendee is new to the system.',
			'required' => 0,
			'conditional_logic' => 0,
