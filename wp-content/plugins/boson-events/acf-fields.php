	...
	acf_add_local_field_group(array(
	  ...
	  'fields' => array(
		  ...
		  array(
			...
			array(
				'key' => 'field_5b214b1ed665b',
				'label' => 'Event terms and conditions',
				'name' => 'event_terms_conditions',
				'type' => 'wysiwyg',
				'instructions' => 'Displays on the event booking form in a popup.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
		  ...
		  array(
			  ...
			  'layouts' => array(
					'layout_5b59b21bacb50' => array(
						'key' => 'layout_5b59b21bacb50',
						'name' => 'latest_news',
						'label' => 'Latest News',
						'display' => 'block',
						'sub_fields' => array(
							array(
								'key' => 'field_5b59b732cd2cb',
								'label' => 'Title',
								'name' => 'title',
								'type' => 'text',
								'instructions' => '',
				  ...
				  '5bc9fbd2cd9aa' => array(
					...
					'layout_5h5b3f22q12db' => array(
						'key' => 'layout_5h5b3f22q12db',
						'name' => 'related_team',
						'label' => 'Selected Team Members',
						'display' => 'block',
						'sub_fields' => array(
							array(
								'key' => 'field_5b9hd2e999be2',
								'label' => 'Heading',
								'name' => 'heading',
								'type' => 'text',
								'instructions' => '',
