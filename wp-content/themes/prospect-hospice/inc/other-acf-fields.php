...
acf_add_local_field_group(array(
	'key' => 'group_5b7586adc8efe',
	'title' => 'Contact Us',
	'fields' => array(
		array(
			'key' => 'field_5b7586b200d11',
			'label' => 'Contact Form ID',
			'name' => 'contact_form_id',
			'type' => 'number',
			'instructions' => 'Contact form ID',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5b758aa057356',
			'label' => 'Wellbeing Centre Address',
			'name' => 'wellbeing_centre_address',
			'type' => 'google_map',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5b758ab057357',
			'label' => 'Distribution Centre Address',
			'name' => 'distribution_centre_address',
			'type' => 'google_map',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					'key' => 'field_5b91527d3c539',
					'label' => 'Find Shop Button',
					'name' => 'find_shop_button',
					'type' => 'group',
					'instructions' => 'Display a button to take users to \'Find shop\' page',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
		...
		array(
			'key' => 'field_5b759331c036a',
			'label' => 'Useful Telephone Numbers',
			'name' => 'useful_telephone_numbers',
			'type' => 'group',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
...
acf_add_local_field_group(array(
	'key' => 'group_5b9faa97216c5',
	'title' => 'Donate',
	'fields' => array(
		array(
			'key' => 'field_5b9fba3fa296e',
			'label' => 'Donate Introduction',
			'name' => 'donate_introduction',
			'type' => 'group',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			...
			'sub_fields' => array(
				array(
					'key' => 'field_5b9faae3ac3b0',
					'label' => 'Single Donation',
					'name' => 'single_donation',
					'type' => 'group',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
					...
					'sub_fields' => array(
						...
						array(
							'key' => 'field_5b9fac2ca02b2',
							'label' => 'Donate Form Id',
							'name' => 'donate_form_id',
							'type' => 'number',
							'instructions' => '',
							'required' => 0,
				...
				array(
					'key' => 'field_5b9fab69ac3b5',
					'label' => 'Regular Donations',
					'name' => 'regular_donations',
					'type' => 'group',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
					...
					'sub_fields' => array(
						...
						array(
							'key' => 'field_5b9fab76ac3ba',
							'label' => 'Button Link',
							'name' => 'button_link',
							'type' => 'text',
							'instructions' => 'Link to external website',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
	...
	'location' => array(
		array(
			array(
				'param' => 'page_template',
				'operator' => '==',
				'value' => 'templates/page-donate.php',
			),
		),
	),
	'menu_order' => 0,
...
acf_add_local_field_group(array(
	'key' => 'group_5b74463232781',
	'title' => 'Education contact page fields',
	'fields' => array(
		array(
			'key' => 'field_5b744641b4338',
			'label' => 'Related Team',
			'name' => 'related_team',
			'type' => 'relationship',
			'instructions' => '',
		...
		array(
			'key' => 'field_5b744668b4339',
			'label' => 'Form ID',
			'name' => 'form_id',
			'type' => 'number',
			'instructions' => 'Please enter the ID fo the Gravity form you wish to use.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
	...
	'location' => array(
		array(
			array(
				'param' => 'page_template',
				'operator' => '==',
				'value' => 'templates/page-team-contact.php',
			),
		),
	),
	'menu_order' => 0,
...
acf_add_local_field_group(array(
	'key' => 'group_5b58763e47b75',
	'title' => 'Homepage',
	'fields' => array(
		array(
			'key' => 'field_5b587663eafb5',
			...
			'sub_fields' => array(
				array(
					'key' => 'field_5b5876b1eafb6',
					'label' => 'Background Image',
					'name' => 'background_image',
					'type' => 'image',
					'instructions' => 'Recommended image size:
Square - 700px wide x 500px high
Full width - 1400px x 700px high',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					'key' => 'field_5b58772eeafb8',
					'label' => 'Page Link',
					'name' => 'page_link',
					'type' => 'post_object',
					'instructions' => 'Select where this block will take you to',
					'required' => 1,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_5b5f291124e14',
			'label' => 'Benefits Section Background Colour',
			'name' => 'benefits_section_background_colour',
			'type' => 'select',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
...
acf_add_local_field_group(array(
	'key' => 'group_5b58565eaef8b',
	'title' => 'Menu',
	'fields' => array(
		array(
			'key' => 'field_5b585674a0730',
			'label' => 'Menu Content',
			'name' => 'menu_content',
			'type' => 'true_false',
			'instructions' => 'Select to "True" if this is a content block. If used, blocks must be the first child link in a dropdown.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
	...
	'location' => array(
		array(
			array(
				'param' => 'nav_menu_item',
				'operator' => '==',
				'value' => 'location/main-navigation',
			),
		),
	),
	'menu_order' => 0,
